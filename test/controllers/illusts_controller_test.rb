...
class IllustsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create illust" do
    assert_difference('Illust.count') do
      post illusts_url, params: { illust: { author: @illust.author, illust: @illust.illust, memo: @illust.memo, title: @illust.title, user_id: @illust.user_id } }
    end
  ...
  test "should update illust" do
    patch illust_url(@illust), params: { illust: { author: @illust.author, illust: @illust.illust, memo: @illust.memo, title: @illust.title, user_id: @illust.user_id } }
